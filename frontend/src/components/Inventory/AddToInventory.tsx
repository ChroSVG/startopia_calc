...
const AddToInventory = ({ trigger }: AddToInventoryProps) => {
  ...
  return (
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      ...
      <SheetContent
        side="right"
        className="flex w-full flex-col border-l-2 p-0 sm:max-w-md"
      >
        {/* Header */}
          ...
          <SheetHeader className="p-0">
            <div className="flex items-center gap-3">
              ...
              <div className="space-y-0.5">
                <SheetTitle className="text-2xl font-black italic tracking-tight uppercase leading-none">
                  Find Items
                </SheetTitle>
            ...
            <div className="py-6 space-y-8 animate-in fade-in slide-in-from-right-4 duration-300">
              ...
              <div className="space-y-6">
                ...
                <div
                  ...
                  style={{
                    borderColor: selectedItem.seed_color
                      ? `${selectedItem.seed_color}44`
                      : "var(--muted)",
                    background: selectedItem.seed_color
                      ? `radial-gradient(circle at center, ${selectedItem.seed_color}22, transparent)`
                      : "var(--muted/10)",
                  }}
                >
                  ...
                  {selectedItem.seed_color ? (
                    <div
                      ...
                      style={{
                        backgroundColor: selectedItem.seed_color.split(" ")[0],
                      }}
                    />
                  ) : (
                ...
                <div className="text-center space-y-2">
                  ...
                  <div className="flex items-center justify-center gap-2">
                    {selectedItem.rarity && (
                      <Badge
                        variant="outline"
                        className="uppercase font-black italic tracking-widest text-[10px]"
                      >
                        {selectedItem.rarity}
                      </Badge>
                    )}
            ...
            <div className="py-2 space-y-2">
              {items.length > 0 ? (
                items.map((item) => (
                  ...
                  >
                    <div
                      ...
                      style={{
                        backgroundColor: item.seed_color
                          ? `${item.seed_color}11`
                          : "transparent",
                        borderColor: item.seed_color
                          ? `${item.seed_color}33`
                          : "var(--muted)",
                      }}
                    >
                      {item.seed_color ? (
                        <div
                          ...
                          style={{
                            backgroundColor: item.seed_color.split(" ")[0],
                          }}
                        />
                      ) : (
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="font-bold truncate group-hover:text-primary transition-colors italic uppercase tracking-tight">
                        {item.name}
                      </div>
                ...
                <div className="py-20 text-center">
                  ...
                  <p className="text-xs text-muted-foreground/50 uppercase tracking-widest mt-1">
                    Try another keyword
                  </p>
                </div>
              ) : (
